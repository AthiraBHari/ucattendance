  ...
  <body id="page-top">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!--  Buttons  -->
          <div class="box-btn">
              <a class="btn btn-outline-dark btn-bread" href="viewAttendance.php?batch=<?php echo $_GET['batch'] ?>">Back</a>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach($conn->query('SELECT A.name,B.absent FROM attendance B, student A WHERE B.subject = '.$_GET['batch'].' AND B.date="'.$_GET['date'].'" AND A.id = B.student ORDER BY B.date ASC') as $row){
                      ...
                      if($flag == 1){
                        echo '<div class="col-12 alert alert-primary" role="alert">
                        No Attendance data added
                      </div>';
                      }
                    ?>
                  </div>
